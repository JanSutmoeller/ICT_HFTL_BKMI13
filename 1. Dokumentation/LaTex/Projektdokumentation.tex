...
morekeywords={public, class, long, return, byte, int, private, import, final, extends, implements, static, if, else, null, void, super, while, new, boolean, protected, default, switch, case, break, try, catch, for, package, true, default, this},
...
emph={mCameraView, VISIBLE, GONE, surface_view, activity_main, length, cluster, previewImage, modeSelector, quantizationMode, fileName, QUANT_MODE_0, QUANT_MODE_1, QUANT_MODE_1_STRING, DIRECTORY_DCIM, COLOR_RGBA2BGRA, CV_8UC4, rootPath, mPictureFileName, cameraView},
emphstyle=\color{lila},
belowcaptionskip=1\baselineskip,
breaklines=true,
showstringspaces=false,
...
\fancyhead[L]{QuantiPig-APP}
\fancyhead[C]{}
\fancyhead[R]{Projektarbeit ICT}
